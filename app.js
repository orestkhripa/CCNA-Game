...
const QBANK={
net_basics:[
 {q:"Qual è la definizione corretta di LAN?",o:["Rete che copre un'area geografica limitata come un ufficio o edificio","Rete che collega città o nazioni diverse","Rete pubblica gestita da un ISP","Collegamento punto-punto tra due router"],c:0,e:"Una LAN (Local Area Network) copre un'area ristretta come casa, ufficio o campus, con alta velocità e bassa latenza."},
 {q:"Che cosa distingue una WAN da una LAN?",o:["La WAN copre grandi distanze geografiche, spesso tramite provider terzi","La WAN è sempre più veloce della LAN","La WAN usa solo cavi in fibra","La WAN non può trasportare traffico IP"],c:0,e:"Una WAN (Wide Area Network) collega reti distanti geograficamente, tipicamente affidandosi a service provider."},
 {q:"In una topologia a stella, come sono collegati i dispositivi?",o:["Ogni dispositivo si collega a un nodo centrale (switch/hub)","Ogni dispositivo è collegato a formare un anello","Tutti condividono un unico cavo dorsale","Ogni dispositivo è collegato a tutti gli altri"],c:0,e:"Nella topologia a stella tutti i nodi si connettono a un dispositivo centrale; un guasto a un cavo isola solo quel nodo."},
 ...
 {q:"Qual è la differenza principale tra hub e switch?",o:["Lo switch inoltra i frame solo alla porta di destinazione usando la MAC; l'hub ripete a tutte le porte","L'hub è più veloce dello switch","Lo switch opera solo a livello 3","L'hub crea VLAN, lo switch no"],c:0,e:"Lo switch mantiene una tabella MAC e inoltra in modo selettivo; l'hub trasmette a tutte le porte (un unico dominio di collisione)."},
 {q:"Cosa significa comunicazione full-duplex?",o:["Invio e ricezione simultanei senza collisioni","Solo un dispositivo può trasmettere alla volta","La comunicazione avviene solo in una direzione","Richiede sempre un hub"],c:0,e:"Il full-duplex permette trasmissione e ricezione contemporanee, eliminando le collisioni (tipico dei link switch-a-dispositivo)."},
 {q:"Quale unità misura tipicamente la larghezza di banda di un collegamento?",o:["Bit per secondo (bps)","Byte totali","Hertz","Pacchetti per sessione"],c:0,e:"La banda si misura in bit per secondo (Mbps, Gbps): è la capacità teorica massima del collegamento."},
 ...
 {q:"In un modello client-server, cosa caratterizza il server?",o:["Fornisce risorse o servizi ai client che ne fanno richiesta","Richiede sempre risorse agli altri nodi","Non ha indirizzo IP","È sempre un dispositivo wireless"],c:0,e:"Il server ospita e fornisce servizi (web, file, DNS...) mentre i client li richiedono."},
 {q:"Qual è un vantaggio della fibra ottica rispetto al rame?",o:["Immunità alle interferenze elettromagnetiche e distanze maggiori","Costa sempre meno","È più facile da terminare","Trasporta corrente elettrica"],c:0,e:"La fibra usa impulsi di luce: non è soggetta a EMI e supporta distanze e banda molto superiori al rame."},
 {q:"Cosa rappresenta il 'throughput' reale di una rete?",o:["La quantità effettiva di dati trasferiti nell'unità di tempo","La velocità massima teorica del mezzo","Il numero di dispositivi collegati","La lunghezza del cavo"],c:0,e:"Il throughput è la velocità realmente raggiunta, spesso inferiore alla banda nominale per overhead e congestione."},
 {q:"Quale topologia offre la massima ridondanza collegando ogni nodo a tutti gli altri?",o:["Mesh (magliata) completa","Bus","Stella","Anello singolo"],c:0,e:"Nella mesh completa ogni dispositivo ha un link diretto con ogni altro: massima ridondanza ma costo elevato."}
],
binary:[
 ...
 {q:"Quanti valori diversi può rappresentare un ottetto (8 bit)?",o:["256 (da 0 a 255)","255","128","512"],c:0,e:"Con 8 bit si hanno 2^8 = 256 combinazioni, cioè valori da 0 a 255."},
 ...
 {q:"Quanti indirizzi teorici offre uno spazio a 32 bit (IPv4)?",o:["Circa 4,3 miliardi (2^32)","65.536","16 milioni","2^16"],c:0,e:"IPv4 usa 32 bit: 2^32 circa 4,29 miliardi di indirizzi totali."},
...
osi_mod:[
 ...
 {q:"Nel modello OSI, il livello Session (5) si occupa di:",o:["Stabilire, gestire e terminare le sessioni tra applicazioni","Instradare i pacchetti","Assegnare indirizzi MAC","Convertire i segnali elettrici"],c:0,e:"Il livello Session apre, coordina e chiude i dialoghi/sessioni tra host."}
],
tcpip_mod:[
 ...
 {q:"Quale meccanismo TCP evita che il mittente saturi il ricevente?",o:["Controllo di flusso tramite finestra (windowing)","Broadcast storm control","Split horizon","CSMA/CD"],c:0,e:"TCP usa il windowing per adattare la quantità di dati inviati alla capacità del ricevente."},
 ...
 {q:"Il modello TCP/IP a 4 livelli è composto da:",o:["Application, Transport, Internet, Network Access","Fisico, Dati, Rete, Sessione","7 livelli come OSI","Solo TCP e IP"],c:0,e:"Il modello TCP/IP raggruppa in 4 livelli: Application, Transport, Internet, Network Access."},
 ...
 {q:"Nel handshake TCP, il numero di sequenza serve a:",o:["Ordinare i byte e rilevare dati mancanti","Cifrare i dati","Assegnare indirizzi IP","Identificare la VLAN"],c:0,e:"I sequence number permettono di riordinare i segmenti e individuare/ritrasmettere i dati persi."},
...
ip_addr:[
 ...
 {q:"L'indirizzo 127.0.0.1 è:",o:["L'indirizzo di loopback locale","Un indirizzo pubblico","Un indirizzo broadcast","Un indirizzo APIPA"],c:0,e:"127.0.0.0/8 è riservato al loopback; 127.0.0.1 testa lo stack TCP/IP locale."},
 ...
 {q:"Quale intervallo è riservato agli indirizzi multicast?",o:["224.0.0.0 - 239.255.255.255 (classe D)","240.0.0.0/4","192.168.0.0/16","172.16.0.0/12"],c:0,e:"La classe D (224.0.0.0/4) è usata per il multicast; la classe E (240/4) è sperimentale."},
 {q:"Cosa identifica la porzione host di un indirizzo IP?",o:["Il singolo dispositivo all'interno della rete","La rete di appartenenza","Il gateway predefinito","Il server DNS"],c:0,e:"L'IP si divide in porzione di rete (comune) e porzione host (univoca per ogni dispositivo)."},
 ...
 {q:"Un indirizzo con tutti i bit host a 1 rappresenta:",o:["L'indirizzo di broadcast della subnet","L'indirizzo di rete","Il primo host utilizzabile","Il gateway"],c:0,e:"Host tutti a 1 = broadcast; host tutti a 0 = indirizzo di rete. Nessuno dei due è assegnabile a un host."},
 {q:"Perché sono necessari gli indirizzi privati e il NAT?",o:["Per far fronte all'esaurimento degli indirizzi IPv4 pubblici","Perché sono più veloci","Perché sono più sicuri di IPv6","Per abilitare il multicast"],c:0,e:"Gli indirizzi privati più il NAT permettono di condividere pochi IP pubblici, mitigando l'esaurimento IPv4."},
...
subnetting:[
 ...
 {q:"Cosa significa VLSM?",o:["Variable Length Subnet Mask - maschere di lunghezza variabile","Very Large Subnet Mask","Virtual LAN Subnet Method","Variable Link State Metric"],c:0,e:"Il VLSM consente maschere di diversa lunghezza sulla stessa rete, ottimizzando lo spazio indirizzi."},
...
switching:[
 {q:"Come costruisce lo switch la sua tabella MAC?",o:["Impara la MAC sorgente dei frame in ingresso associandola alla porta","Interroga il server DHCP","Usa il protocollo OSPF","Legge l'indirizzo IP di destinazione"],c:0,e:"Lo switch esamina la MAC sorgente dei frame ricevuti e associa MAC-porta nella tabella CAM."},
 {q:"Cosa fa uno switch con un frame per una MAC destinazione sconosciuta?",o:["Fa flooding su tutte le porte tranne quella d'ingresso","Scarta il frame","Lo invia solo al gateway","Genera un errore ARP"],c:0,e:"Con MAC destinazione sconosciuta lo switch fa flooding (unknown unicast) su tutte le porte eccetto la sorgente."},
 {q:"Qual è lo scopo principale dello Spanning Tree Protocol (STP)?",o:["Prevenire i loop di livello 2 in topologie ridondanti","Assegnare indirizzi IP","Cifrare il traffico VLAN","Instradare tra subnet diverse"],c:0,e:"STP (802.1D) blocca logicamente i link ridondanti per evitare loop e broadcast storm a livello 2."},
 ...
 {q:"In STP, quale switch diventa la root bridge?",o:["Quello con il bridge ID più basso","Quello con più porte","Quello con l'IP più alto","Quello configurato per ultimo"],c:0,e:"La root bridge è lo switch con il bridge ID (priorità + MAC) più basso."},
 {q:"Cosa rappresenta un dominio di collisione?",o:["Un segmento in cui i frame possono collidere tra loro","L'insieme dei dispositivi che ricevono un broadcast","Una VLAN","Una subnet IP"],c:0,e:"Ogni porta switch è un dominio di collisione separato; l'hub invece li condivide tutti."},
 ...
 {q:"Cosa succede a un frame con MAC destinazione broadcast (FFFF.FFFF.FFFF)?",o:["Viene inoltrato a tutte le porte della VLAN","Viene scartato","Va solo al router","Viene messo in coda STP"],c:0,e:"Il frame broadcast raggiunge tutti i dispositivi del dominio di broadcast/VLAN."},
 ...
 {q:"Cosa introduce Rapid STP (802.1w) rispetto a 802.1D?",o:["Convergenza più rapida dopo un cambiamento di topologia","La cifratura dei BPDU","L'assegnazione automatica delle VLAN","Il routing tra VLAN"],c:0,e:"RSTP (802.1w) riduce drasticamente i tempi di convergenza rispetto allo STP classico."},
 {q:"Un frame Ethernet contiene, oltre ai dati, principalmente:",o:["MAC sorgente, MAC destinazione e FCS","Indirizzi IP sorgente e destinazione","Numeri di porta TCP","Il prefisso CIDR"],c:0,e:"L'header Ethernet ha MAC destinazione, MAC sorgente, EtherType e in coda l'FCS per il controllo errori."}
],
vlan_mod:[
 {q:"Che cosa crea una VLAN su uno switch?",o:["Un dominio di broadcast separato logicamente","Una nuova subnet fisica cablata","Un dominio di collisione","Una tabella di routing"],c:0,e:"Ogni VLAN è un dominio di broadcast separato: dispositivi in VLAN diverse non comunicano senza routing."},
 ...
 {q:"Come comunicano host di VLAN diverse?",o:["Tramite routing (router o switch L3) - inter-VLAN routing","Direttamente sullo stesso switch","Tramite STP","Non possono mai comunicare"],c:0,e:"Serve un dispositivo di livello 3 (router-on-a-stick o switch L3) per instradare tra VLAN."},
 {q:"Cos'è la native VLAN su un trunk 802.1Q?",o:["La VLAN il cui traffico viaggia non taggato sul trunk","La prima VLAN creata","La VLAN di management obbligatoria","Una VLAN che blocca il traffico"],c:0,e:"Il traffico della native VLAN (default 1) attraversa il trunk senza tag; va allineata su entrambi i lati."},
 ...
 {q:"Quante VLAN supporta il campo VLAN ID a 12 bit?",o:["4094 utilizzabili (0 e 4095 riservate)","1024","256","65535"],c:0,e:"Il VLAN ID è a 12 bit (0-4095); 1-4094 sono utilizzabili, 0 e 4095 riservate."},
 {q:"Cos'è il 'router-on-a-stick'?",o:["Un router con una interfaccia fisica suddivisa in sottointerfacce per VLAN","Un router senza routing table","Uno switch di livello 2","Un access point"],c:0,e:"Il router-on-a-stick usa sottointerfacce (una per VLAN) su un unico link trunk per l'inter-VLAN routing."},
 ...
 {q:"Un vantaggio di segmentare la rete in VLAN è:",o:["Ridurre i domini di broadcast e migliorare sicurezza e gestione","Aumentare le collisioni","Eliminare la necessità di switch","Velocizzare lo spanning tree"],c:0,e:"Le VLAN riducono la dimensione dei domini di broadcast, isolano i gruppi e semplificano la gestione."},
 ...
 {q:"Il protocollo che propaga automaticamente le VLAN tra switch Cisco è:",o:["VTP (VLAN Trunking Protocol)","STP","CDP","OSPF"],c:0,e:"VTP sincronizza il database VLAN tra switch dello stesso dominio (attenzione ai rischi di sovrascrittura)."}
],
routing_s:[
 ...
 {q:"Cosa rappresenta il 'next hop' in una rotta statica?",o:["L'indirizzo IP del router successivo verso la destinazione","La rete di destinazione finale","L'interfaccia di loopback","Il gateway del PC"],c:0,e:"Il next hop è l'IP del router adiacente a cui inoltrare i pacchetti per quella destinazione."},
 {q:"Nella tabella di routing, cosa indica una rotta 'connected' (C)?",o:["Una rete direttamente collegata a un'interfaccia attiva","Una rotta appresa via OSPF","Una rotta statica","Una rotta di default"],c:0,e:"Le reti direttamente connesse (codice C) hanno AD 0 e appaiono appena l'interfaccia è up con IP."},
 {q:"Cos'è una floating static route?",o:["Una rotta statica di backup con AD più alta della primaria","Una rotta senza next hop","Una rotta dinamica","Una rotta multicast"],c:0,e:"La floating static ha una AD maggiore così entra in tabella solo se la rotta primaria cade."},
 {q:"Perché una rotta statica ha AD più bassa di OSPF?",o:["Perché è configurata manualmente ed è considerata più affidabile","Perché è più veloce","Perché usa meno CPU","Non è vero, ha AD più alta"],c:0,e:"L'AD misura l'affidabilità della sorgente: la statica (1) è preferita a OSPF (110)."},
 {q:"Il comando 'show ip route' mostra:",o:["La tabella di routing del router","La configurazione delle VLAN","La tabella ARP","Lo stato dello spanning tree"],c:0,e:"'show ip route' elenca reti connesse, statiche e apprese con AD e metriche."},
 ...
 {q:"Cosa succede senza una rotta verso la destinazione e senza default route?",o:["Il router scarta il pacchetto","Il router fa flooding","Il pacchetto va in broadcast","Il router crea una rotta automatica"],c:0,e:"Senza corrispondenza in tabella né default route, il pacchetto viene scartato."},
 {q:"Il routing statico è più adatto a:",o:["Reti piccole e stabili","Reti molto grandi e mutevoli","Ambienti con molti cambi di topologia","Backbone Internet"],c:0,e:"La statica non scala e non reagisce ai cambi: ideale per reti piccole/stub o rotte di default."},
...
ospf_mod:[
 ...
 {q:"Su cosa si basa di default la metrica (cost) di OSPF?",o:["Sulla larghezza di banda dell'interfaccia","Sul numero di hop","Sul ritardo","Sul carico"],c:0,e:"Il costo OSPF = banda di riferimento / banda dell'interfaccia; link più veloci hanno costo minore."},
 {q:"Cos'è l'area 0 in OSPF?",o:["L'area backbone a cui tutte le altre aree si collegano","Un'area di sola lettura","L'area dei router di confine","Un'area senza router"],c:0,e:"L'area 0 è il backbone: in OSPF multi-area tutte le aree devono connettersi ad essa."},
 {q:"Come stabiliscono l'adiacenza i router OSPF?",o:["Scambiando pacchetti Hello per formare relazioni di neighbor","Con il three-way handshake TCP","Tramite broadcast ARP","Con messaggi DHCP"],c:0,e:"OSPF usa pacchetti Hello (multicast 224.0.0.5) per scoprire i vicini e mantenere le adiacenze."},
 ...
 {q:"In una rete multiaccesso, OSPF elegge un ___ per ridurre gli scambi di LSA.",o:["DR (Designated Router)","Root bridge","Gateway","Master DHCP"],c:0,e:"Su reti broadcast OSPF elegge un DR e un BDR per limitare le adiacenze e il traffico LSA."},
 {q:"OSPF invia gli aggiornamenti di routing:",o:["Solo quando cambia la topologia (più gli Hello periodici)","Ogni 30 secondi l'intera tabella","In broadcast continuo","Mai, è statico"],c:0,e:"Essendo link-state, OSPF inonda LSA solo ai cambiamenti; RIP invece manda periodicamente l'intera tabella."},
 ...
 {q:"Cosa contiene il Link-State Database (LSDB) di OSPF?",o:["La mappa completa della topologia dell'area","Solo le rotte di default","Le tabelle MAC","Gli indirizzi DHCP assegnati"],c:0,e:"L'LSDB raccoglie tutti gli LSA: ogni router nell'area ha una copia identica della topologia."},
 {q:"Un vantaggio di OSPF rispetto a RIP è:",o:["Scalabilità e convergenza rapida senza limite di hop","È più semplice da configurare","Usa meno memoria","Non richiede indirizzi IP"],c:0,e:"OSPF scala molto meglio, converge rapidamente e non ha il limite dei 15 hop di RIP."}
],
eigrp_mod:[
 ...
 {q:"Cos'è il 'successor' in EIGRP?",o:["Il percorso migliore verso una destinazione, installato in tabella","Un percorso di backup","Il router vicino con MAC più alto","La rotta di default"],c:0,e:"Il successor è il next hop con la metrica migliore (feasible distance minima); va nella routing table."},
 {q:"Cos'è il 'feasible successor'?",o:["Un percorso di backup precalcolato senza loop","Il percorso principale","Un router non raggiungibile","Il DR della rete"],c:0,e:"Il feasible successor è una rotta di riserva già validata come loop-free, usata se il successor cade."},
 ...
 {q:"EIGRP invia aggiornamenti di routing:",o:["Solo quando ci sono cambiamenti (partial e bounded)","Ogni 30 secondi la tabella intera","Solo in broadcast","Mai"],c:0,e:"EIGRP invia aggiornamenti parziali e limitati solo ai router interessati quando cambia qualcosa."},
 ...
 {q:"La 'feasible distance' in EIGRP è:",o:["La metrica totale più bassa verso una destinazione","La distanza del vicino verso la destinazione","Il numero di hop","La banda del link"],c:0,e:"La feasible distance è la migliore metrica calcolata localmente verso la rete di destinazione."}
],
acl_mod:[
 ...
 {q:"Quale range numerico identifica le ACL standard IPv4?",o:["1-99 (e 1300-1999)","100-199","200-299","0-99"],c:0,e:"Le ACL standard usano 1-99 (e 1300-1999); le extended 100-199 (e 2000-2699)."},
 ...
 {q:"Cos'è una wildcard mask in una ACL?",o:["Una maschera inversa: 0 = bit da confrontare, 1 = bit ignorato","Una subnet mask normale","Un indirizzo broadcast","Un numero di porta"],c:0,e:"La wildcard è l'inverso della subnet mask: 0 = il bit deve corrispondere, 1 = il bit è ignorato."},
 ...
 {q:"Le ACL extended possono filtrare in base a:",o:["Protocollo, IP sorgente/destinazione e numero di porta","Solo IP sorgente","Solo indirizzo MAC","Solo VLAN ID"],c:0,e:"Le extended (100-199) filtrano su protocollo (TCP/UDP/ICMP), IP sorgente e destinazione e porte."},
 {q:"Come vengono valutate le regole di una ACL?",o:["Dall'alto verso il basso, prima corrispondenza vince","In ordine casuale","Solo l'ultima conta","In ordine di specificità automatica"],c:0,e:"Le ACL sono processate top-down: appena una regola fa match, viene applicata e la valutazione si ferma."},
 {q:"Una named ACL offre il vantaggio di:",o:["Nomi descrittivi e modifica delle singole righe","Maggiore velocità hardware","Filtrare i MAC","Sostituire il routing"],c:0,e:"Le named ACL usano nomi significativi e consentono di aggiungere/rimuovere righe specifiche più facilmente."},
...
nat_mod:[
 {q:"Cosa fa il NAT (Network Address Translation)?",o:["Traduce indirizzi IP privati in pubblici e viceversa","Cifra i pacchetti","Assegna VLAN","Calcola le rotte"],c:0,e:"Il NAT modifica gli indirizzi IP nell'header dei pacchetti, tipicamente da privati (RFC1918) a pubblici."},
 {q:"Cosa distingue il PAT (NAT overload) dal NAT statico?",o:["Il PAT mappa molti IP privati su un solo IP pubblico usando le porte","Il PAT usa un IP pubblico per ogni privato","Il PAT non usa le porte","Il PAT funziona solo con IPv6"],c:0,e:"Il PAT (overload) condivide un unico IP pubblico tra molti host distinguendo le sessioni tramite le porte."},
 ...
 {q:"Il NAT statico è tipicamente usato per:",o:["Esporre server interni con un IP pubblico fisso","Assegnare IP ai client DHCP","Creare VLAN","Bilanciare il carico"],c:0,e:"Il NAT statico crea una mappatura 1:1 fissa, utile per rendere raggiungibili server (web, mail) dall'esterno."},
 ...
 {q:"Su un router, quale interfaccia va marcata 'ip nat inside'?",o:["L'interfaccia verso la rete privata (LAN)","L'interfaccia verso Internet","L'interfaccia loopback","Tutte le interfacce"],c:0,e:"'ip nat inside' si mette sulla LAN privata, 'ip nat outside' sull'interfaccia pubblica (WAN)."},
 {q:"Un vantaggio di sicurezza del NAT è:",o:["Nasconde la struttura di indirizzamento interno","Cifra il traffico","Blocca tutti i virus","Autentica gli utenti"],c:0,e:"Il NAT maschera gli IP interni: dall'esterno si vede solo l'IP pubblico."},
 ...
 {q:"Un limite del NAT è:",o:["Può complicare applicazioni P2P e protocolli che includono l'IP nel payload","Rallenta sempre la LAN a metà","Impedisce l'uso di TCP","Richiede IPv6"],c:0,e:"Il NAT può rompere applicazioni che incorporano indirizzi nel payload (es. alcuni VoIP/FTP) senza ALG."},
 {q:"Il NAT è meno necessario con IPv6 perché:",o:["Lo spazio di indirizzamento è enorme e ogni host può avere un IP globale","IPv6 non supporta il NAT","IPv6 è più lento","IPv6 usa solo indirizzi privati"],c:0,e:"IPv6 offre uno spazio così vasto da rendere superfluo il NAT per la conservazione degli indirizzi."}
],
ssh_sec:[
 {q:"Perché SSH è preferito a Telnet per la gestione remota?",o:["SSH cifra la sessione, Telnet la trasmette in chiaro","SSH è più veloce","Telnet non funziona sui router","SSH non richiede password"],c:0,e:"SSH cifra credenziali e dati; Telnet invia tutto in chiaro ed è vulnerabile allo sniffing."},
 {q:"Quale porta usa SSH di default?",o:["22","23","443","80"],c:0,e:"SSH usa la porta TCP 22; Telnet la 23."},
 {q:"Cosa fa la port security su uno switch?",o:["Limita gli indirizzi MAC ammessi su una porta","Cifra il traffico VLAN","Assegna IP statici","Crea trunk automatici"],c:0,e:"La port security restringe quali/quanti MAC possono usare una porta, bloccando accessi non autorizzati."},
 ...
 {q:"Perché usare 'enable secret' invece di 'enable password'?",o:["enable secret memorizza un hash, enable password è debolmente cifrata","Sono identici","enable password è più sicuro","enable secret non richiede password"],c:0,e:"'enable secret' salva un hash molto più sicuro della 'enable password'."},
 ...
 {q:"Cosa serve per abilitare SSH su un router Cisco?",o:["Hostname, ip domain-name e chiavi RSA generate","Solo abilitare Telnet","Un server DHCP","Una VLAN dedicata"],c:0,e:"Servono hostname, ip domain-name e 'crypto key generate rsa', più utenti locali/AAA."},
 {q:"Cos'è una MAC 'sticky' nella port security?",o:["Un MAC appreso dinamicamente e salvato nella config","Un MAC casuale","Un indirizzo broadcast","Un MAC bloccato"],c:0,e:"Con 'port-security mac-address sticky' lo switch impara il MAC e lo salva nel running-config."},
 {q:"Perché disabilitare le porte switch inutilizzate?",o:["Per ridurre la superficie di attacco e accessi non autorizzati","Solo per risparmiare energia","Per velocizzare STP","Non serve a nulla"],c:0,e:"Le porte inattive andrebbero spente (shutdown) e messe in una VLAN parcheggio per sicurezza."},
 {q:"Un login banner (MOTD) serve principalmente a:",o:["Avvisare legalmente gli utenti sull'accesso autorizzato","Cifrare la sessione","Assegnare privilegi","Configurare AAA"],c:0,e:"Il banner MOTD mostra un avviso legale/di sicurezza; è buona prassi anche se non protegge tecnicamente."}
],
ipv6_mod:[
 ...
 {q:"IPv6 ha eliminato quale concetto presente in IPv4?",o:["Il broadcast (sostituito dal multicast)","Il multicast","Gli indirizzi unicast","Il routing"],c:0,e:"IPv6 non usa il broadcast: le funzioni sono svolte da multicast e anycast."},
 {q:"Cos'è SLAAC in IPv6?",o:["Autoconfigurazione stateless dell'indirizzo","Un protocollo di routing","Un tipo di ACL","Un server DHCP obbligatorio"],c:0,e:"SLAAC permette all'host di generarsi l'indirizzo dal prefisso annunciato dal router (RA)."},
 {q:"Quale protocollo sostituisce ARP in IPv6?",o:["NDP (Neighbor Discovery Protocol)","RARP","ICMPv4","DHCP"],c:0,e:"NDP usa messaggi ICMPv6 (NS/NA, RS/RA) per scoperta vicini, risoluzione indirizzi e router discovery."},
 ...
 {q:"A cosa serve l'indirizzo multicast FF02::1 in IPv6?",o:["Raggiungere tutti i nodi sul link locale","Raggiungere tutti i router","Loopback","Broadcast globale"],c:0,e:"FF02::1 = tutti i nodi del link; FF02::2 = tutti i router del link."}
],
wan_mod:[
 {q:"Cosa fornisce una VPN site-to-site?",o:["Un tunnel cifrato tra due sedi attraverso Internet","Una LAN wireless","Un servizio DHCP","Una VLAN estesa fisicamente"],c:0,e:"La VPN site-to-site connette in modo sicuro reti di sedi diverse cifrando il traffico su Internet."},
 ...
 {q:"Cos'è GRE?",o:["Un protocollo di tunneling che incapsula vari protocolli, senza cifratura nativa","Un protocollo di cifratura","Un protocollo di routing","Uno standard VLAN"],c:0,e:"GRE incapsula pacchetti in un tunnel ma non cifra: spesso combinato con IPSec per la sicurezza."},
 {q:"Cosa caratterizza MPLS?",o:["Inoltra i pacchetti in base a etichette (label) invece del solo IP","Cifra tutto il traffico","È un protocollo wireless","Assegna VLAN"],c:0,e:"MPLS usa label switching per instradare rapidamente i pacchetti nella rete del provider."},
 ...
 {q:"Una VPN client-to-site (remote access) serve a:",o:["Connettere un singolo utente remoto alla rete aziendale","Collegare due data center","Sostituire lo switch","Creare VLAN"],c:0,e:"La remote access VPN permette a un lavoratore remoto di accedere in sicurezza alla LAN aziendale."},
 ...
 {q:"Cosa fornisce la 'broadband' come tecnologia WAN?",o:["Accesso Internet condiviso ad alta velocità (DSL, cavo, fibra)","Un circuito dedicato garantito","Solo connettività wireless","Un tunnel cifrato automatico"],c:0,e:"Broadband (DSL/cavo/fibra) offre accesso Internet ad alta velocità su mezzo condiviso, senza banda garantita."},
 {q:"Quale protocollo IPSec fornisce cifratura del payload?",o:["ESP (Encapsulating Security Payload)","AH (Authentication Header)","IKE da solo","GRE"],c:0,e:"ESP cifra e autentica il payload; AH offre solo autenticazione/integrità senza cifratura."},
 {q:"Un vantaggio della VPN rispetto a una leased line è:",o:["Costo inferiore usando Internet come trasporto","Banda sempre garantita","Latenza nulla","Nessuna cifratura necessaria"],c:0,e:"La VPN sfrutta Internet (economico) al posto di circuiti dedicati costosi, a scapito di garanzie di banda."}
],
auto_mod:[
 ...
 {q:"Cosa usa una API REST per le operazioni?",o:["Metodi HTTP come GET, POST, PUT, DELETE","Comandi CLI Cisco","Pacchetti OSPF","Frame Ethernet"],c:0,e:"Le REST API sfruttano i verbi HTTP (GET/POST/PUT/DELETE) per interagire con le risorse."},
 ...
 {q:"Cos'è un controller SDN?",o:["Un sistema centralizzato che gestisce le decisioni di inoltro dei dispositivi","Uno switch di livello 2","Un tipo di cavo","Un server DHCP"],c:0,e:"Il controller SDN centralizza l'intelligenza di rete e programma i dispositivi tramite southbound API."},
 ...
 {q:"Un vantaggio dell'automazione di rete è:",o:["Configurazioni coerenti e ripetibili, meno errori umani","Elimina la necessità di indirizzi IP","Rende inutile la sicurezza","Aumenta gli errori manuali"],c:0,e:"L'automazione riduce gli errori manuali garantendo configurazioni standardizzate e scalabili."},
 {q:"Cosa sono le 'northbound API' in SDN?",o:["Interfacce tra il controller e le applicazioni/orchestratori","Interfacce tra controller e switch","Cavi in fibra","Protocolli di routing"],c:0,e:"Le northbound API espongono le funzioni del controller alle applicazioni; le southbound parlano coi dispositivi."},
 ...
 {q:"Cos'è l'Infrastructure as Code (IaC)?",o:["Gestire l'infrastruttura tramite file di codice versionabili","Cablare fisicamente i data center","Un linguaggio di programmazione","Un protocollo di routing"],c:0,e:"IaC descrive l'infrastruttura in file di codice (versionati in Git), rendendo i deployment ripetibili."}
]
};
...
QBANK.wifi_mod=[
 {q:"In una rete wireless aziendale, qual è il ruolo del WLC (Wireless LAN Controller)?",o:["Gestisce e configura centralmente decine di Access Point","Sostituisce il router di bordo","Assegna gli indirizzi MAC ai client","Cifra il traffico via IPSec"],c:0,e:"Il WLC gestisce in modo centralizzato molti AP 'lightweight': canali, potenza, SSID e roaming, senza configurarli uno per uno."},
 ...
 {q:"Cos'è un SSID?",o:["Il nome identificativo di una rete wireless","L'indirizzo MAC dell'Access Point","La chiave di cifratura WPA2","Il canale radio utilizzato"],c:0,e:"L'SSID (Service Set Identifier) è il nome della WLAN che i client vedono e a cui si associano."},
 ...
 {q:"Cosa descrive un AP in modalità 'autonoma' (autonomous)?",o:["Un AP che si configura da solo senza WLC","Un AP che funziona solo via cavo","Un AP che instrada pacchetti IP","Un AP senza SSID"],c:0,e:"Un AP autonomo ha la propria configurazione locale; un AP 'lightweight' dipende invece dal WLC."}
];
QBANK.redun_mod=[
 {q:"A cosa serve lo Spanning Tree Protocol (STP) in una rete switched?",o:["A prevenire i loop di livello 2 bloccando i percorsi ridondanti","Ad accelerare il routing IP","A cifrare i frame Ethernet","Ad assegnare le VLAN automaticamente"],c:0,e:"STP (802.1D/RSTP) evita i loop L2 mettendo in blocco le porte ridondanti, lasciando un solo percorso attivo."},
 {q:"Cosa fa EtherChannel?",o:["Aggrega più link fisici in un unico link logico","Crea una VLAN per ogni porta","Cifra il traffico tra due switch","Converte rame in fibra"],c:0,e:"EtherChannel (LACP/PAgP) unisce più link in uno logico: più banda e ridondanza, e STP lo vede come un solo collegamento."},
 {q:"Qual è lo scopo di HSRP?",o:["Fornire un gateway predefinito ridondante e virtuale","Assegnare indirizzi IP ai client","Filtrare il traffico per porta","Sincronizzare l'orario dei router"],c:0,e:"HSRP (First Hop Redundancy) fa condividere a due router un IP virtuale: se l'attivo cade, lo standby subentra come gateway."},
 ...
 {q:"Il protocollo LACP appartiene a quale tecnologia?",o:["EtherChannel (aggregazione di link)","HSRP","DHCP","OSPF"],c:0,e:"LACP (802.3ad) è lo standard aperto per negoziare l'aggregazione di link in un EtherChannel; PAgP è l'equivalente Cisco."}
];
QBANK.ipserv_mod=[
 ...
 {q:"A cosa serve il DNS?",o:["A tradurre i nomi di dominio in indirizzi IP","A cifrare il traffico web","Ad assegnare gli indirizzi IP ai client","A sincronizzare l'orario"],c:0,e:"Il DNS risolve nomi (es. kuehne-nagel.com) negli indirizzi IP necessari per instradare i pacchetti. Porta UDP/TCP 53."},
 ...
 {q:"A cosa serve Syslog?",o:["A raccogliere e centralizzare i messaggi di log dei dispositivi","Ad assegnare gli IP","A creare le VLAN","A cifrare le password"],c:0,e:"Syslog (UDP 514) invia i messaggi di log a un server centrale, con livelli di severità da 0 (emergency) a 7 (debug)."},
 ...
 {q:"Cosa fa la QoS (Quality of Service) in rete?",o:["Dà priorità al traffico sensibile come voce e video","Assegna gli indirizzi IP","Cifra i pacchetti","Blocca le porte inutilizzate"],c:0,e:"La QoS classifica e prioritizza il traffico (es. VoIP) per garantire bassa latenza quando la banda è satura."},
